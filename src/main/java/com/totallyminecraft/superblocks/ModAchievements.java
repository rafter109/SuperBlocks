...
public class ModAchievements {
    ...
    public static void init(){
        ...
        burnbaby = new Achievement("achievement.burnbaby", "superblocks.burnbaby", 0, 0, ModItems.cuttingtorchItem, null).initIndependentStat().registerStat();
        ...
        thehardway = new Achievement("achievement.thehardway", "superblocks.thehardway", -1, -2, Item.getItemFromBlock(com.totallyminecraft.superblocksore.blocks.ModBlocks.lithiumoreBlock), null).initIndependentStat().registerStat();
        ...
        AchievementPage.registerAchievementPage(new AchievementPage("SuperBlocks", burnbaby, plankbyplank, secretwood, abittoasty, thehardway));
